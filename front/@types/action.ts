...
import { MatchingCounts, Schedule, ScheduleModel, Schedules } from "./schedule";
...
export type ScheduleActions =
  ...
  | { type: typeof LOAD_SCHEDULES_REQUEST; payload: LoadSchedulesProps }
  ...
  | { type: typeof LOAD_SCHEDULE_SUCCESS; data: { schedule: Schedule; userMatching: MatchingCounts; friendMatching: MatchingCounts; } }
